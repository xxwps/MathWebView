...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final LatexLibraryAccessors laccForLatexLibraryAccessors = new LatexLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>androidmath</b> with <b>com.github.gregcockroft:AndroidMath</b> coordinates and
     * with version reference <b>androidMath</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getAndroidmath() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("androidmath");
    }
    ...
    /**
     * Group of libraries at <b>latex</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public LatexLibraryAccessors getLatex() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForLatexLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class LatexLibraryAccessors extends SubDependencyFactory {

        public LatexLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>renderer</b> with <b>io.github.huarangmeng:latex-renderer</b> coordinates and
         * with version reference <b>latexRenderer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidMath</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidMath() { return getVersion("androidMath"); }
        ...
        /**
         * Version alias <b>guava</b> with value <b>31.1-android</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>latexRenderer</b> with value <b>1.3.0-kt2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLatexRenderer() { return getVersion("latexRenderer"); }
        ...
        /**
         * Version alias <b>webkit</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>lifecycle</b> which contains the following dependencies:
         * <ul>
    ...
    public static class AndroidxBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>androidx.core</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("androidx.core");
        }
